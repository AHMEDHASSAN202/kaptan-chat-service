...
type CuisineUseCase interface {
	...
	List(ctx *context.Context, dto *cuisine.ListCuisinesDto) (*[]Cuisine, validators.ErrorResponse)
...
type CuisineRepository interface {
	...
	List(ctx *context.Context, query *cuisine.ListCuisinesDto) (*[]Cuisine, error)
