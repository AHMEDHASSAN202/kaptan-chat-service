...
const (
    ...
    CanNotBuildChatResponse = "CanNotBuildChatResponse" // Internal server errors occurred. Please contact support.
    CanNotChangeApprovalStatus = "CanNotChangeApprovalStatus" // CanNotChangeApprovalStatus
    ChangeChatStatusError = "ChangeChatStatusError" // ChangeChatStatusError
    ChatCollectionMethodError = "ChatCollectionMethodError" // ChatCollectionMethodError
    ...
    UserHasRunningChats = "UserHasRunningChats" // UserHasRunningChats
