...
type MyFatoorahService interface {
	...
	GetUserCards(ctx context.Context, userId string) (initSessionResponse responses.InitSessionResponse, err validators.ErrorResponse)
	...
	DeleteUserCardToken(ctx context.Context, userCardToken string) (err validators.ErrorResponse)
}
